...
jQuery(document).ready(function($) {
    ...
    $('.projects-container ul li').bgLoaded({
        afterLoaded: function() {
            showCaption($('.projects-container ul li').eq(0));
        }
    });
    ...
    //close project
    $('.projects-container .container-close').on('click', function() {
        toggleProject($('.is-full-width'), $('.projects-container'), false);
    });

    //scroll to project info
    $('.projects-container .container-scroll').on('click', function() {
    ...
    function toggleProject(project, container, bool) {
        if (bool) {
            ...
            project.animate({opacity: 0}, 800, function() {
                ...
                $('.projects-container').find('.container-scroll').attr('style', '');
                setTimeout(function() {
                    project.attr('style', '').removeClass('is-full-width').find('.container-title').attr('style', '');
                }, delay);
                setTimeout(function() {
                    showCaption($('.projects-container ul li').eq(0));
                }, 300);
    ...
    function changeOpacity() {
        ...
        $('.projects-container .container-scroll').css('opacity', newOpacity);
        $('.is-full-width .container-title').css('opacity', newOpacity);
    }
